    ...
    private static async Task EnsureTestProducts(ApplicationDbContext context)
    {
        if (!context.Products.Any())
        {
            var testProducts = new List<Product>
            {
                ...
                new Product { Name = "Mens Shoes - White", Description = "The Gildan Ultra Shoe is made from a substantial 6.0 oz. per sq. yd. fabric constructed from 100% cotton, this classic fit preshrunk jersey knit provides unmatched comfort with each wear. Featuring a taped neck and shoulder, and a seamless double-needle collar, and available in a range of colors, it offers it all in the ultimate head-turning package.", Price = 29.99m, Stock = 100, ThumbnailImageUrl = "images/product1.png", Category = "Party"},
                new Product { Name = "Mens Shoes - White", Description = "The Gildan Ultra Shoe is made from a substantial 6.0 oz. per sq. yd. fabric constructed from 100% cotton, this classic fit preshrunk jersey knit provides unmatched comfort with each wear. Featuring a taped neck and shoulder, and a seamless double-needle collar, and available in a range of colors, it offers it all in the ultimate head-turning package.", Price = 14.99m, Stock = 100, ThumbnailImageUrl = "images/product2.png", Category = "Casual"},
                new Product { Name = "Premium Blue Shoes", Description = "The Gildan Ultra Shoe is made from a substantial 6.0 oz. per sq. yd. fabric constructed from 100% cotton, this classic fit preshrunk jersey knit provides unmatched comfort with each wear. Featuring a taped neck and shoulder, and a seamless double-needle collar, and available in a range of colors, it offers it all in the ultimate head-turning package.", Price = 16.99m, Stock = 100, ThumbnailImageUrl = "images/product14.png", Category = "Party"},
